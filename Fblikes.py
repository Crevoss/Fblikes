...
{ab}-----------------------------------------------
{d}Developer   : {g}Crevo
{d}Telegram  : {g}@crevodazma
{d}Author  : {g}Crevo
{d}Youtube  : {g}https://www.youtube.com/@crevoofficialyt
{d}Github   : {g}https://github.com/Crevoss
{d}Facebook : {g}https://www.facebook.com/profile.php?id=100084245913360
{ab}-----------------------------------------------""")
